    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-line-soft rounded-xl p-6">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div><label className="block text-xs font-medium text-muted mb-1">Ort. Kıdem (ay)</label><input type="number" inputMode="numeric" className={ic} value={form.avg_tenure_mon} onChange={e => setForm(p => ({...p, avg_tenure_mon: parseFloat(e.target.value)||0}))} step={0.1} /></div>
